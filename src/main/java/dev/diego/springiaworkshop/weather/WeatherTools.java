package dev.diego.springiaworkshop.weather;
...
public class WeatherTools {
    ...
    public WeatherTools(RestClient.Builder builder) {
        this.restClient = builder
                ...
                .defaultHeader("User-Agent", "WeatherApiClient/1.0 (diegoooh2o@gmail.com)")
                .build();
    }
    ...
    public record Points(@JsonProperty("properties") Props properties){
        @JsonIgnoreProperties(ignoreUnknown = true)
        public record Props(@JsonProperty("forecast") Props forecast){
    ...
    public String getWeatherForecastByLocation(double latitude, double longitude) {
        ...
        assert points != null;
        var forecast = restClient.get().uri(String.valueOf(points.properties().forecast())).retrieve().body(Forecast.class);

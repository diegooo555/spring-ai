package dev.diego.springiaworkshop.multimodal.audio;
...
public class AudioGeneration {
    ...
    @GetMapping("/speak")
    public ResponseEntity<byte[]> generateAudio(@RequestParam( defaultValue = "Itś a good time for be a Java & Spring Developer") String text){
